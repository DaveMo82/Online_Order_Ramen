...
const Menu = () => {
    ...
    return (
        <header className="bg-header flex justify-between items-center p-4 ">
            ...
            <input type="text" placeholder="Search" className="rounded w-60 pl-4 ml-64"/>
            <nav>
            <ul className="list-none flex text-xl">
              <li className="inline mr-4">
              <Link to="/favorite">
                <img src="/assets/favorite.png" alt="einkaufwagen" className="w-6"/>
              </Link>
              </li>
              <li className="inline mr-4">
              <Link to="/card">
                <img src="/assets/einkaufswagen.png" alt="einkaufwagen" className="w-6"/>
              </Link>
              </li>
              <li>
